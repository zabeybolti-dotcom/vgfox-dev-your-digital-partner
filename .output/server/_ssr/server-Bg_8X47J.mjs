...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DMMPAABf.mjs");
...
var ROUTER_BASEPATH = "vgfox-dev-your-digital-partner";
var SERVER_FN_BASE = "/vgfox-dev-your-digital-partner/_serverFn/";
