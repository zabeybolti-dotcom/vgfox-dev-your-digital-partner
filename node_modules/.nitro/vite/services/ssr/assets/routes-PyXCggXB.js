...
import { ArrowDown, ArrowRight, ChevronRight, FileText, Mail, Menu, MoreVertical, Send, X } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("header", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("nav", {
					...
					children: [/* @__PURE__ */ jsx("button", {
						...
						children: "Главная"
					}), links.map((l) => /* @__PURE__ */ jsx("button", {
						onClick: () => go(l.href),
						className: "apple-link text-[12px] text-white/80",
						children: l.label
					}, l.href))]
				}),
				/* @__PURE__ */ jsx("div", { className: "hidden md:block w-16" }),
				/* @__PURE__ */ jsx("button", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(motion.button, {
				...
				children: "Главная"
			}), links.map((l, i) => /* @__PURE__ */ jsx(motion.button, {
				initial: {
					opacity: 0,
					y: 6
				},
...
function Hero() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black via-transparent to-black z-10" }),
			/* @__PURE__ */ jsxs(motion.div, {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(AppleLink, {
							href: TELEGRAM_URL,
							external: true,
							...
							children: ["Мои услуги ", /* @__PURE__ */ jsx(ArrowDown, {
								className: "w-4 h-4",
								strokeWidth: 2
							})]
						})]
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("h2", {
				...
				children: PROJECTS_DATA.map((p, i) => /* @__PURE__ */ jsx(motion.div, {
					initial: {
						opacity: 0,
						y: 30
					},
					...
					children: p.id === 2 ? /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									}), /* @__PURE__ */ jsx(MoreVertical, { className: "w-4 h-4 text-neutral-400" })]
								}), /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: ["Привет! Помоги расшифровать общий анализ крови. Гемоглобин 110, это нормально?", /* @__PURE__ */ jsxs("span", {
											className: "text-[9px] text-[#7da3c5] absolute bottom-1 right-2 flex items-center gap-0.5",
											children: ["14:20", /* @__PURE__ */ jsx("svg", {
												className: "w-3 h-3",
												viewBox: "0 0 16 11",
												fill: "none",
										...
										children: ["Гемоглобин 110 г/л ниже нормы для взрослых. Это может указывать на легкую анемию. Рекомендую проконсультироваться с терапевтом для подбора витаминов или железа.", /* @__PURE__ */ jsx("span", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsx("div", { className: "absolute top-2 left-0 right-0 h-1.5 bg-white/5 rounded-full" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-7 left-0 right-0 h-1.5 bg-white/5 rounded-full" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-7 left-0 w-3/5 h-1.5 bg-gradient-to-r from-purple-500/40 to-transparent rounded-full" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-12 left-0 right-0 h-0.5 bg-white/[0.03] rounded-full" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-16 left-0 right-2/3 h-1 bg-white/5 rounded-full" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-20 left-0 right-1/4 h-1 bg-white/5 rounded-full" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-24 left-0 right-1/2 h-1 bg-gradient-to-r from-blue-500/30 to-transparent rounded-full" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-28 left-1/3 right-0 h-1 bg-white/5 rounded-full" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-[56px] left-[60%] w-14 h-14 rounded-full bg-purple-600/20 blur-xl" }),
										/* @__PURE__ */ jsx("div", { className: "absolute top-[52px] left-[58%] w-12 h-12 rounded-full bg-blue-500/20 blur-xl" }),
										/* @__PURE__ */ jsx("div", {
											...
											children: /* @__PURE__ */ jsx("div", { className: "w-3 h-3 rounded-full bg-gradient-to-br from-purple-400 to-blue-400 blur-[1px]" })
										})
									]
								})
							})]
					...
					/* @__PURE__ */ jsxs(motion.div, {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "w-16 h-px bg-gradient-to-r from-purple-500/60 to-transparent" }),
								/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs(motion.div, {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "w-px bg-white/[0.06] hidden md:block" }),
								/* @__PURE__ */ jsxs("div", {
									className: "flex-1",
									children: [/* @__PURE__ */ jsx("p", {
										className: "text-xs font-semibold text-neutral-500 uppercase tracking-wider mb-4",
				...
				children: [
					...
					return /* @__PURE__ */ jsxs("a", {
						...
						children: [
							...
							/* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4 text-neutral-500 transition-transform duration-300 group-hover:translate-x-0.5" })
						]
					}, b.label);
				})
			}),
